...
/** Return input value from $old, falling back to empty string. */
$v = fn(string $k): string => e($old[$k] ?? '');

/** Return error message for a field or empty string. */
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-0.5">Fill in the details below to create a customer record.</p>
        </div>
    </div>
</div>
...
<form method="POST" action="/customers/store" novalidate class="space-y-6">
    <?= \App\Core\CSRF::field() ?>
